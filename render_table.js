// Import the paginate function from our helper functions file
...
export function createElement(tag, options = {}) {
  ...
  const textContent = options.textContent !== undefined ? options.textContent : null;
  ...
  function renderTableContent() {
    ...
    for (let i = 0; i < columns.length; i++) {
      ...
      const headerCell = createElement("th", {
        ...
        onClick: function() { sortData(columnIndex); },
        classNames: ["sortable"]
      });
